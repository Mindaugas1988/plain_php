...
<div id="page">
  ...
  <nav class="w3-sidenav w3-collapse w3-card-1 w3-animate-left" style="width:200px;" id="mySidenav">
    ...
    <li class="active"><img src="images/chat.png" alt="email"/><a href="pasiskelbk.php">Pasiskelbk</a><span class="w3-tag"></span></li>
  ...
  <span class="w3-opennav w3-xlarge w3-hide-large" onclick="w3_open()">&#9776;</span>
    <div class="w3-col s12" id="post-reader_header">
      <form class="w3-col s12">
        <textarea placeholder="Rašyti skelbimą..." name ="new_post"></textarea>
        <div class="error" id="post_error"></div>
        <input type="button" id="new_post_btn" value="Skelbti"/>
    ...
    <div class="w3-col s12" id="content">
      ...
      <ul class="w3-navbar">
         <li><a href="pasiskelbk.php" >Visi</a></li>
         <li><a href="mano_pasiskelbk.php" style="font-weight:bold;">Tik mano</a></li>
     </ul>
    <div id="sent_box" class="box">
      <?php
      $post->show_my($user_id,$page);
      ?>
    </div>
    <?php
    $row = $post->all_count_user($user_id);
    $location = $_SERVER['PHP_SELF'];
    $pagination = new Pagination($row,5,$page,$location);
    ?>
    </div>
 </div>
