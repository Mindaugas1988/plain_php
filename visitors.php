...
<div id="page">
  ...
  <nav class="w3-sidenav w3-collapse w3-card-1 w3-animate-left" style="width:200px;" id="mySidenav">
    ...
    <li class="active"><img src="images/visitors.png" alt="email"/><a href="visitors.php">Svečiai</a><span class="w3-tag visit"></span></li>
  ...
  <span class="w3-opennav w3-xlarge w3-hide-large" onclick="w3_open()">&#9776;</span>
    ...
    <div id="visitors">
      <?php $visitor->show_visitor($user_id,$page);?>
    </div>
    <?php
    $row = $visitor->count($user_id);
